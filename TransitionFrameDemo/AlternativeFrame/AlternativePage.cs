...
namespace TransitionFrameToolkit
{
    /// <summary>
...
#pragma warning restore 1998
        ...
        /// </summary>
        /// <param name="e">
        /// Event data that can be examined by overriding code. The event data is representativeThe <see cref="TransitionFrameToolkit.AlternativeNavigationEventArgs"/> instance containing the event data.
